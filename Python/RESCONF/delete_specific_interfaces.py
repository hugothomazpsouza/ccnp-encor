...
# Nome da interface a ser deletada
...
url = "https://devnetsandboxiosxe.cisco.com//restconf/data/ietf-interfaces:interfaces/interface=" + interface_name

# Payload vazio para a solicitação DELETE
payload = {}
